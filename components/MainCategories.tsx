...
const Categories = async () => {
  ...
  return (
    <div className='flex-grow p-7 mt-2 mr-2 mb-2 border-2 border-[#0b3c49] border-solid rounded'>
        ...
        <h1 className='w-4/5 text-[#0b3c49] text-lg font-bold ' >Main Categories</h1>
        <Link 
        ...
        {data.length > 0 ? <div className='m-auto flex flex-col mt-5 gap-2 border-2 border-[#0b3c49] border-solid p-5 rounded'>
        {data.map((item : any) => (
